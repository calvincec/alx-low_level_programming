...
1. [Learning Objectives](#learning-objectives)
    1. [General](#general)
    2. [Copyright - Plagiarism](#copyright---plagiarism)
...
3. [Tasks](#tasks)
    ...
    7. [6. Size is not grandeur, and territory does not make a nation](#6-size-is-not-grandeur-and-territory-does-not-make-a-nation)
    8. [7. Intel](#7-intel)
    9. [8. UNIX is basically a simple operating system, but you have to be a genius to understand the simplicity](#8-unix-is-basically-a-simple-operating-system-but-you-have-to-be-a-genius-to-understand-the-simplicity)
